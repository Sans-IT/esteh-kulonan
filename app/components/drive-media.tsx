 ...
 * thumbnail + tombol play tanpa perlu setup lain). Semua video di situs
 * ini sengaja TIDAK autoplay — video baru main kalau tombol play-nya
 * diklik user, supaya perilakunya konsisten & normal di semua browser.
 */
