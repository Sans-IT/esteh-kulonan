    ...
    <section className="border-t border-[var(--color-border)] bg-[var(--color-muted)]/40">
      <div className="mx-auto max-w-5xl px-5 py-16 md:py-20">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2">
          {points.map((p, i) => (
            <FadeInView key={p.title} delay={Math.min(i * 0.08, 0.24)}>
        ...
        <FadeInView>
          <p className="font-body-decorative mx-auto mt-12 max-w-2xl text-center text-sm italic leading-relaxed text-[var(--color-foreground)]/60">
