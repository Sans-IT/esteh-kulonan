...
export const drivePhotos = {
  ...
  franchisePaketB: "1euSo2gKr7Xnl9yJM4as9UJ6utiC_CFbp", // foto gerai Paket Jos
}
...
// CATATAN REVISI: batch foto sebelumnya sempat kepasang geser 1 posisi
// (foto Silverqueen kepasang ke Coklat Royal, dst). Sudah diperbaiki
// semua di bawah ini sesuai judul & harga yang dikonfirmasi ulang oleh
// client per WA (14/9/2026).
driveMenuImages["avocado"] = "1FxZeWZVtRQ1BrBTfxpX1QN51rLHIxsvK"
driveMenuImages["coklat-milo"] = "1UbktoWHainBiZ-lZRD_E2fn9MypMe0zx"
driveMenuImages["coklat-royal"] = "" // belum ada foto yang benar dari client
...
export function driveVideoEmbedUrl(fileId: string) {
  ...
  // Semua video di situs ini TIDAK autoplay — user harus klik tombol
  // play sendiri, sama seperti player bawaan Drive secara default.
